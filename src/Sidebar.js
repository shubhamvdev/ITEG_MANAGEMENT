              ...
              <div class="row justify-content-between align-items-center">
                ...
                <div class="app-utilities col-auto">
                  <div class="app-utility-item app-notifications-dropdown dropdown">
                    <Link to="Info">Registration</Link>
                    <Link to="#">
                  ...
                  <a class="nav-link">
                    ...
                    <div class="collapse" id="collapseExample1">
                      <div class="d-flex" style={{ flexDirection: "column" }}>
                        <NavLink className="my-2" to="/Set">
                          <span class="nav-link-text">Assignment</span>
                        </NavLink>
                        <NavLink className="my-2" to="/Table">
                          <span class="nav-link-text">Time Table</span>
                        </NavLink>
                        {/* <NavLink className="my-2" to="!acdminctable">
